...
alias dmm_backfill='cd ~/march-madness && cargo build --release -p march-madness-indexer && ./target/release/indexer backfill --from-block 30749805'
alias dmm_listen='cd ~/march-madness && cargo build --release -p march-madness-indexer && ./target/release/indexer listen'
